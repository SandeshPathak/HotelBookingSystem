 ...
 */
public class HotelBookingSystemGUICode extends javax.swing.JFrame {
    ...
    public int singleCounter = 0; //to count the number of singleBedrooms
    public int doubleCounter = 0; //to count the numbers of doubleBedrooms
    public int deluxeCounter = 0; //to count the numbers of deluxeBedrooms
    ...
    public HotelBookingSystemGUICode() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //bookinginfotextArea.setText("\tPersonal Information\nName:"+this.enteredfirstName+" \nPhone number: "+this.enteredcontactNumber+"\n\n\tBooking Information\nCheck in Date: "+this.formatted_checkin_date+"\nCheck out Date: "+this.formatted_checkout_date+"\nGuests: "+this.totalnumberofGuests+"\nRoom Booked: \n\n\n\n\nPlease see the receptionist for the payment.");
    ...
    private void anothersubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HotelBookingSystemGUICode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HotelBookingSystemGUICode().setVisible(true);
            }
        });
    }
